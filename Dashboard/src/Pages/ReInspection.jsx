...
import MreInspection from './MreInspection'
...
const ReInspection = () => {
  ...
  <div className="w-[281px] left-[93px] top-[217px] absolute text-[#171725] text-2xl font-bold font-['HK Grotesk']">Request For Inspection</div>
  ...
  <div className="w-[336px] h-[74.75px] left-[44px] top-[506px] absolute">
    <div className="w-[129.27px] h-[21px] left-[0.27px] top-[-0px] absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Email</div>
    <div className="w-[336px] h-[54px] left-0 top-[20.75px] absolute">
      <div className="w-[13.68px] h-[23px] left-[5.35px] top-[12.25px] absolute" />
      <input type="text" className="w-[336px] h-[54px] left-0 top-0 absolute rounded-md border pl-3  border-[#bdbdbd]" placeholder="Enter your Email" />
      {/* <div className="w-[117px] left-[13px] top-[18.25px] absolute text-[#828282] text-sm font-medium font-['HK Grotesk']">Enter your Email</div> */}
    </div>
  </div>
  ...
  <div className="w-[336px] h-[74.75px] left-[44px] top-[399px] absolute">
    <div className="w-[336px] h-[74.75px] left-0 top-0 absolute">
      ...
      <div className="w-[336px] h-[54px] left-0 top-[20.75px] absolute">
        <div className="w-[13.68px] h-[23px] left-[5.35px] top-[12.25px] absolute" />
        <input type="text" className="w-[336px] h-[57px] left-0 top-0 absolute pl-9 rounded-md border border-[#bdbdbd]" placeholder="Email Address" />
      </div>
    </div>
    ...
    <div className="w-[52px] h-[0px] left-[263px] top-[22px] absolute origin-top-left rotate-90 border border-[#c5c5c5]"></div>
    <div className="w-[93px] h-[34px] p-[5px] left-[9px] top-[30px] absolute justify-start items-end gap-[5px] inline-flex">
      <div className="w-6 h-6 relative">
        <div className="w-6 h-6 left-0 top-0 mt-[10px] absolute">
          <img src={sms} alt="" />
        </div>
      </div>
    </div>
