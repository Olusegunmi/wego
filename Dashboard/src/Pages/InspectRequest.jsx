...
import MinspectREquest from './MinspectREquest'
...
const InspectRequest = () => {
  ...
  <div className="w-[153px] left-[69px] top-[185px] absolute text-center text-[#521292] text-xs font-medium font-['HK Grotesk'] leading-none"><Link to='/Inspection'>View Inspection Report</Link></div>
  <div className="w-[119px] left-[267px] top-[185px] absolute text-center text-[#521292] text-xs font-medium font-['HK Grotesk'] leading-none">Inspection Request</div>
  <div className="w-[349px] h-[0px] left-[42px] top-[211px] absolute border-2 border-black"></div>
  <div className="w-[133px] h-[0px] left-[261px] top-[211px] absolute border-4 border-[#521292]"></div>
  <div className="w-6 h-6 left-[60px] top-[180px] absolute origin-top-left rotate-180  overflow-hidden" />
  <div className="w-[81px] left-[293px] top-[232px] absolute text-center text-black text-[10px] font-bold font-['HK Grotesk'] leading-none">Property Status</div>
  ...
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[283.25px] absolute bg-[#27ae60] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Done</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[384.25px] absolute bg-[#27ae60] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Done</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[677.25px] absolute bg-[#27ae60] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Done</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[861.25px] absolute bg-[#27ae60] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Done</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[475.25px] absolute bg-[#ae2f26] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Pending</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[578.25px] absolute bg-[#ae2f26] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Pending</div>
  </div>
  <div className="w-[44.82px] h-[13.35px] px-[7.64px] py-[2.29px] left-[316.07px] top-[774.25px] absolute bg-[#ae2f26] rounded-[45.85px] justify-center items-center gap-[7.64px] inline-flex">
    <div className="text-right text-[#fefefe] text-[8px] font-medium font-['Montserrat'] leading-3">Pending</div>
  </div>
