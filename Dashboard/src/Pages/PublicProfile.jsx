...
const PublicProfile = () => {
  ...
  <div className="w-[668.73px] h-[665.22px] left-[706.32px] top-[128.67px] absolute bg-white rounded-[10px]">
    <div className="left-[18.11px] top-[20.43px] absolute text-[#171625] text-lg font-semibold font-['HK Grotesk'] leading-snug">Public Profile</div>
    ...
    <div className="w-[186px] h-[186px] left-[240.08px] top-[72.65px] absolute rounded-full border-2 border-[#521292]" />
    <div className="w-[169.09px] h-[169.09px] left-[248.12px] top-[80.69px] absolute">
      <img className="w-[169.09px] h-[169.09px] left-0 top-0 absolute rounded-full" src={Ellipse} />
    </div>
    <img src={Cam} className="w-[17px] h-[21px] left-[412.72px] top-[192.60px] absolute bg-white rounded-tl-[10px] rounded-tr-[1px] rounded-bl-[1px] rounded-br-[1px]" />


    <div className="w-7 h-7 left-[273.75px] top-[264.27px] absolute" />
    <div className="w-[671px] h-[0px] left-[-1.94px] top-[62.32px] absolute border border-[#eef0f6]"></div>
    <div className="w-[164px] h-[54px] left-[466.78px] top-[574.90px] absolute">
    ...
    <div className="left-[41.20px] top-[274.56px] absolute flex-col justify-start items-start gap-[21px] inline-flex">
      <div className="w-[590px] h-[74.75px] relative">
        <div className="w-[227px] h-[21px] left-[0.48px] top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">User ID</div>
        <div className="w-[590px] h-[54px] left-[0.11px] top-[20.75px] absolute">
          <div className="w-6 h-[23px] left-[9.47px] top-[12.30px] absolute" />
          <input type="text" className="w-[590px] h-[54px] left-0 top-0 absolute pl-7 rounded-md border border-[#bdbdbd]" placeholder='Wego15458252' />
          
        </div>
      </div>
      <div className="justify-start items-start gap-[21px] inline-flex">
        <div className="w-[581.96px] h-[75px] relative">
          <div className="w-[466.80px] h-[21px] left-0 top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Name</div>
          <div className="w-[581.96px] h-[54px] left-[0.11px] top-[21px] absolute">
            <div className="w-[49.41px] h-[23px] left-[19.40px] top-[12.11px] absolute" />
            <input type='text' className="w-[581.96px] h-[54px] left-0 top-0 absolute rounded-md pl-7 border border-[#bdbdbd]" placeholder='Enter your Name' />
         </div>
        </div>
      </div>
      <div className="w-[590px] h-[74.75px] relative">
        <div className="w-[227px] h-[21px] left-[0.48px] top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Email</div>
        <div className="w-[590px] h-[54px] left-[0.11px] top-[20.75px] absolute">
          <div className="w-6 h-[23px] left-[9.47px] top-[12.30px] absolute" />
          <input type='email' className="w-[590px] h-[54px] left-0 top-0 absolute rounded-md border pl-7 border-[#bdbdbd]" placeholder='Enter your email address'/>
  ...
  <div className="w-[107px] h-[42.61px] left-[1261px] top-[917.39px] absolute">
