...
const Mnotification = () => {
 ...
 <div className="w-[371.87px] h-[556.19px] left-[292px] top-[180px] absolute bg-[#fefefe] rounded-[10px]">
  ...
  <div className="w-[668.73px] h-[645.29px] left-[700.48px] top-[183.67px] absolute bg-[#fefefe] rounded-[10px]">
    ...
    <div className="w-7 h-7 left-[273.75px] top-[254.27px] absolute" />
    <div className="w-[671px] h-[0px] left-[-1.94px] top-[62.32px] absolute border border-[#eef0f6]"></div>
    <div className="pl-6 pr-[27.52px] py-[15px] left-[44.06px] top-[99.57px] absolute bg-[#f8f6fc] rounded-[5px] justify-center items-start gap-[195px] inline-flex overflow-hidden">
      <div className="self-stretch justify-start items-center gap-[45px] inline-flex">
        <div className="w-[290px] h-4 text-[#494949] text-xs font-medium font-['HK Grotesk']leading-none">Allow Push Notification</div>
      </div>
      <div className="w-[39.48px] h-6 relative">
      <img src={Tg} alt="" />
      </div>
    </div>
    <div className="pl-6 pr-[27.52px] py-[15px] left-[44.51px] top-[183.58px] absolute bg-[#f8f6fc] rounded-[5px] justify-center items-start gap-[195px] inline-flex overflow-hidden">
      <div className="self-stretch justify-start items-center gap-[45px] inline-flex">
    ...
    <div className="pl-6 pr-[27.52px] py-[15px] left-[44.96px] top-[267.58px] absolute bg-[#f8f6fc] rounded-[5px] justify-center items-start gap-[195px] inline-flex overflow-hidden">
      <div className="self-stretch justify-start items-center gap-[45px] inline-flex">
    ...
    <div className="w-[164px] h-[54px] left-[458.47px] top-[545.85px] absolute">
