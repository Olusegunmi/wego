...
<div className="p-2 left-[287px] top-[23px] absolute justify-start items-center gap-[11px] inline-flex">
    ...
    <div className="w-[668.73px] h-[811.50px] left-[700.37px] top-[181.67px] absolute bg-[#fefefe] rounded-[10px]">
      ...
      <div className="h-[548.98px] left-[39.28px] top-[111.55px] absolute flex-col justify-center items-start gap-[25px] inline-flex">
        <div className="w-[590px] h-[27px] relative">
          <div className="w-[99px] left-[12.60px] top-[1.07px] absolute text-center text-[#521292] text-xs font-medium font-['HK Grotesk'] leading-none">General info</div>
          <div className="w-[134px] left-[149.60px] top-[0.82px] absolute text-center text-[#838ea6] text-xs font-medium font-['HK Grotesk'] leading-none"><Link to='/Date'>Date and time setting</Link></div>
          <div className="w-[590px] h-[0px] left-[0.15px] top-[26.99px] absolute border border-[#bdbdbd]"></div>
          <div className="w-[118px] h-[0px] left-[0.74px] top-[27px] absolute border-4 border-[#521292]"></div>
        </div>
        <div className="w-[590.43px] h-[493.74px] relative flex-col justify-start items-start flex">
          <div className="w-[590px] h-[178.75px] relative">
            <div className="w-[227px] h-[21px] left-[0.48px] top-0 absolute mt-[10px] text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Font size</div>
            {/* <div className="w-[590px] h-[54px] left-[0.11px] top-[20.75px] absolute">
              <div className="w-6 h-[23px] left-[9.47px] top-[12.30px] absolute" />
              <input type="text" className="w-[590px] h-[54px] text-[13px] pl-3 left-0 top-0 absolute rounded-md border border-[#bdbdbd]" placeholder="Default" />
            </div> */}

            <select className="w-[590px] h-[54px] mt-[30px] text-[13px] pl-3 left-0 top-0 absolute rounded-md border border-[#bdbdbd]">
          ...
          <div className="h-[198.28px] pl-[2.35px] pr-[47.60px] pt-[0.01px] pb-44 justify-start items-center inline-flex">
            <label className="w-[227px] h-[21px] text-[#3d4b55] mt-[-159px] text-sm font-bold font-['HK Grotesk'] leading-tight">Theme</label>
            <select className="w-[590px] h-[54px] left-0 top-0 mt-[120px] absolute pl-3 text-[13px] rounded-md border border-[#bdbdbd]" style={{zIndex:1}}>
             ...
             {/* <div className="w-[590px] h-[54px] left-[0.67px] top-[124.76px] absolute">
              <div className="w-6 h-[23px] left-[9.47px] top-[12.30px] absolute" />
              <input type="text" className="w-[590px] h-[54px] left-0 top-0 absolute pl-3 text-[13px] rounded-md border border-[#bdbdbd]" placeholder="White"  />
            </div> */}
          </div>
          ...
          {/* <div className="w-[590px] h-[139.52px] relative mt-[-250px]">
            <div className="w-[227px] h-[21px] left-[0.76px] top-[64.52px] absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Language</div>
            <div className="w-[590px] h-[139.52px] left-0 top-0 absolute">
              <img src={Ard} className="w-6 h-[23px] left-[10.34px] top-[97.58px] absolute" style={{zIndex:3}} />
              <input type="text" className="w-[590px] h-[54px] left-[0.46px] top-[85.52px] absolute pl-3 rounded-md border border-[#bdbdbd]" placeholder="English"  />
              </div>
          </div> */}

          <div className="w-[590px] h-[139.52px] relative mt-[-250px]">
            <label htmlFor="" className="w-[227px] h-[21px] left-[0.76px] top-[64.52px] absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Language</label>
            <select  className="w-[590px] h-[54px] left-[0.46px] top-[85.52px] absolute text-[13px] pl-3 rounded-md border border-[#bdbdbd]">
          ...
          <div className="w-[178.25px] h-[75.24px] relative">
            ...
            <div className="w-[84px] h-[54px] left-[0.37px] top-[21.24px] absolute">
              ...
              <div className="left-[29.10px] top-[18.27px] absolute text-[#fefefe] text-sm font-medium font-['HK Grotesk']">LTR</div>
            </div>
            <div className="left-[123.47px] top-[40.03px] absolute text-[#828282] text-sm font-medium font-['HK Grotesk']">RTL</div>
            <div className="w-[127px] h-[21px] left-0 top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Layout</div>
          </div>
        </div>
      </div>
    ...
    <div className="w-[371.87px] h-[556.19px] left-[292px] top-[180px] absolute bg-[#fefefe] rounded-[10px]">
      ...
      <div className="h-[174.86px] left-[19.31px] top-[178.11px] absolute flex-col justify-start items-start gap-1 inline-flex">
        <div className="pl-6 pr-[45px] py-[15px] bg-[#eee7f4] rounded-[5px] justify-start items-center inline-flex overflow-hidden">
    ...
    {/* <img src={Ard} className=' absolute left-[1088px] top-[500px]  text-black' alt="" />
