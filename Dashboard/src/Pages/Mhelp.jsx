...
<div className="p-2 left-[287px] top-[23px] absolute justify-start items-center gap-[11px] inline-flex">
 ...
 <div className="w-[5px] h-[47px] left-[243px] top-[483px] absolute bg-[#521292] rounded-[1px]" />
         ...
         <div className="pl-6 pr-[45px] py-[15px] hover:bg-[#eee7f4] rounded-[5px] justify-start items-center inline-flex overflow-hidden">
           <div className="self-stretch justify-center items-center gap-[61px] inline-flex">
             <div className="justify-start items-start gap-[9px] flex">
               ...
               <div className="w-[137px] h-4 text-[#494949] text-sm font-medium font-['HK Grotesk'] leading-none">Get Help</div>
             </div>
  ...
  <div className="w-[677px] h-[728px] left-[693px] top-[188px] absolute bg-white  overflow-hidden">
    <div className="w-[30px] h-[30px] left-[603px] top-[202px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[269px] absolute">
     <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[336px] absolute">
    <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[403px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[470px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[537px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[604px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[30px] h-[30px] left-[603px] top-[671px] absolute">
      <img src={Arc} alt="" />
    </div>
    <div className="w-[525px] h-[0px] left-[31px] top-[110px] absolute border border-[#bdbdbd]"></div>
    <div className="w-[119px] left-[31px] top-[24px] absolute text-[#521292] text-xl font-bold font-['HK Grotesk'] uppercase">Help Centre</div>
    <div className="w-[245px] left-[32px] top-[81px] absolute text-[#171725]/50 text-sm font-medium font-['HK Grotesk']">we would like be for assistance</div>
  </div>
  <div className="w-[381px] h-[41px] left-[731px] top-[317px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to Download Inspection report</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[384px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to Edit Profile</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[451px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to Request for inspection report</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[518px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to view property </div>
  <div className="w-[381px] h-[41px] left-[731px] top-[585px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">Tour Assistance </div>
  <div className="w-[381px] h-[41px] left-[731px] top-[652px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">Video Tutorials</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[719px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to use setting menu</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[786px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to view Inspection report</div>
  <div className="w-[381px] h-[41px] left-[731px] top-[853px] absolute text-[#939393] text-[22px] font-medium font-['HK Grotesk'] capitalize">How to Download Inspection report</div>
