...
const Help = () => {
    ...
    <div className="w-[336px] h-[54px] pl-[23.70px] pr-[106.30px] hover:bg-[#eee7f4] pt-[14.72px]  pb-[22.28px] rounded-[5px] justify-start items-center inline-flex overflow-hidden">
      <div className="self-stretch justify-center items-center gap-[61px] inline-flex">
        <div className="justify-start items-start gap-[9px] flex">
          ...
          <div className="w-[137px] h-4 text-[#494949] text-sm font-medium font-['HK Grotesk'] absolute left-[70px]  leading-none"><Link to='/ContactUs'>Contact Us</Link></div>
        </div>
        <div className="w-6 h-6 justify-center items-center flex">
          <div className="w-6 h-6 absolute left-[268px]">
            <img src={Arc} alt="" />
  ...
  <div className="w-[375px] pl-[31px] pt-6 pb-[472.35px] left-[26px] top-[395px] absolute bg-white flex-col justify-start items-start gap-[11px] inline-flex overflow-hidden">
    <div className="w-[151px] text-[#521292] text-xl font-bold font-['HK Grotesk'] uppercase">Help Centre</div>
    <div className="w-[245px] text-[#171725]/50 text-sm font-medium font-['HK Grotesk']">we would like be for assistance</div>
  </div>
  <div className="w-[329px] h-[41px] left-[47px] top-[520px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to Download Inspection report</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[567px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to Edit Profile</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[614px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to Request for inspection report</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[661px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to view property </div>
  <div className="w-[329px] h-[41px] left-[47px] top-[707px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">Tour Assistance </div>
  <div className="w-[329px] h-[41px] left-[47px] top-[755px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">Video Tutorials</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[802px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to use setting menu</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[849px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to view Inspection report</div>
  <div className="w-[329px] h-[41px] left-[47px] top-[896px] absolute text-[#939393] text-base font-medium font-['HK Grotesk'] capitalize">How to Download Inspection report</div>
         ...
         <div className="w-[222px] h-[352px] left-0 top-0 absolute">
           ...
           <div className="w-[200px] h-[47px] hover:bg-[#eee7f4] hover:hover:border-r-[#521292] hover:border-r-8  left-0 top-[299px] absolute justify-start items-start gap-3.5 inline-flex">
             <div className="p-2 justify-start items-center gap-[11px] flex">
               ...
               <div className="w-[152px] text-[#521292] text-base font-normal font-['HK Grotesk'] leading-tight tracking-tight">Help</div>
             </div>
             <div className="w-[5px] h-[47px] opacity-0 bg-white rounded-[1px]" />
           </div>
