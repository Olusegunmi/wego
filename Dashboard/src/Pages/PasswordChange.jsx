...
const PasswordChange = () => {
  ...
  <div className="w-[1440px] h-[1024px] relative bg-white  overflow-hidden">
    ...
    <div className="w-[668.73px] h-[609.34px] left-[699.28px] top-[129px] absolute bg-white rounded-[10px]">
      <div className="left-[18.11px] top-[19.50px] absolute text-[#171625] text-lg font-semibold font-['HK Grotesk'] leading-snug">Password Change</div>
      <div className="left-[584.14px] top-[23.77px] absolute justify-start items-center gap-[7px] inline-flex">
        ...
        <div className="opacity-80 text-[#bdbdbd] text-xs font-normal font-['HK Grotesk'] leading-tight tracking-tight"><Link>Search</Link></div>
      </div>

      <div className="w-7 h-7 left-[273.75px] top-[236.27px] absolute" />
      <div className="w-[671px] h-[0px] left-[-1.94px] top-[62.32px] absolute border border-[#eef0f6]"></div>
      <div className="w-[164px] h-[54px] left-[287.45px] top-[506.59px] absolute">
      ...
      <div className="w-[164px] h-[54px] left-[464.46px] top-[507.56px] absolute">
        <div className="w-[164px] h-[54px] left-0 top-0 absolute rounded-md border border-[#ff0033]" />
        <div className="left-[62.10px] top-[17.79px] absolute text-[#ff0033] text-base font-medium font-['HK Grotesk']  capitalize"><Link>Clear</Link></div>
      </div>

      <div className="left-[38.28px] top-[104.54px] absolute flex-col justify-start items-start gap-[21px] inline-flex">
        <div className="w-[590px] h-[75px] relative">
          <div className="w-[227px] h-[21px] left-[0.48px] top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk']  leading-tight">Old password</div>
          <div className="w-[590px] h-[54px] left-[0.11px] top-[21px] absolute">
            <div className="w-6 h-[23px] left-[9.47px] top-[12.05px] absolute" />
            <input type='text' className="w-[590px] h-[54px] left-0 top-0 absolute pl-7 rounded-md border font-['HK Grotesk'] border-[#bdbdbd]" placeholder='Enter your old password' />
          </div>
        </div>
        <div className="flex-col justify-start items-start gap-2 flex">
          <div className="w-[590px] h-[73.76px] relative">
            <div className="w-[227px] h-[21px] left-[1.34px] top-[0.01px] absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk']  leading-tight">New password</div>
            <div className="w-[590px] h-[54px] left-[0.11px] top-[19.76px] absolute">
              <div className="w-6 h-[23px] left-[10.42px] top-[13.30px] absolute" />
              <input type='text' className="w-[590px] h-[54px] left-0 top-0 absolute rounded-md border font-['HK Grotesk'] pl-7 border-[#bdbdbd]" placeholder='Enter your new password' />
            </div>
          </div>

          <div className="p-2.5 opacity-60 bg-[#f1f3f6] rounded-md justify-start items-start gap-2.5 inline-flex">
            <div className="w-[569px] text-black text-xs font-medium font-['HK Grotesk'] leading-none">The password should contain one upper case, one lower case, one special character, and numbers. It should be a minimum of 8 characters.</div>
          </div>
        </div>

        <div className="w-[590px] h-[74.67px] relative">
          <input type='text' className="w-[590px] h-[54px] left-[0.11px] top-[20.68px] absolute rounded-md font-['HK Grotesk'] pl-7 border border-[#bdbdbd]" placeholder='Re-type your new password' />
          <div className="w-[148px] h-4 left-[0.41px] top-0 absolute text-[#3d4b55] text-sm font-bold font-['HK Grotesk'] leading-tight">Confirm password</div>
        </div>
      </div>
    </div>


    <div className="w-[107px] h-[42.61px] left-[1264px] top-[917.39px] absolute">
